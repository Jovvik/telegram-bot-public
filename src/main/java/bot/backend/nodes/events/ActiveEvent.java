...
public class ActiveEvent extends OutDoorEvent {
	...
	public static final ClassField<ActiveEvent, List<ActiveType>> ACTIVE_TYPE = new ClassField<>(ActiveEvent::getActiveTypes, ActiveEvent::setActiveTypes, "activeType");
}
